<template>
  <div class="cart container">
    ...
    <div class="row">
      <div class="col-md-12 col-12" v-for="item in carts" :key="item.product.id + 'carts'">
    ...
    <div class=" total flex-wrap row no-gutters">
      <p class="font-xxl text-md-right col-md-12 col-6 offset-3 offset-md-0">總計$: {{total}}</p>
